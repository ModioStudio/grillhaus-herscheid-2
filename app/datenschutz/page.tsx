  ...
  return (
    <main className="min-h-screen bg-white text-black px-6 py-12">
      <div className="mx-auto w-full max-w-3xl space-y-8">
        <article className="space-y-3 [&_h1]:mb-4 [&_h1]:text-3xl [&_h1]:font-bold [&_h1]:tracking-tight [&_h2]:pt-4 [&_h2]:text-xl [&_h2]:font-semibold [&_h3]:pt-2 [&_h3]:text-lg [&_h3]:font-semibold [&_h4]:text-base [&_h4]:font-semibold [&_p]:leading-relaxed [&_p]:text-black/85 [&_ul]:list-disc [&_ul]:pl-6 [&_li]:leading-relaxed [&_li]:text-black/85 [&_a]:text-blue-600 [&_a]:underline">
