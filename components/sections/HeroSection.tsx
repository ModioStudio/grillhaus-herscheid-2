...
export default function HeroSection() {
  return (
    <section
      id="start"
      className="relative min-h-screen flex items-start md:items-center pt-8 md:pt-16 bg-neutral-900/50"
    >
      ...
      <div className="container mx-auto px-4 z-10 relative">
        <div className="max-w-3xl">
          ...
          <p className="text-xl text-zinc-300 mb-6">
            Familie Gabrelas heißt Sie herzlich willkommen – genießen Sie frisch
            gegrillte Spezialitäten in gemütlicher Atmosphäre.
          </p>
